...
public class SimpleVKTCalculator {
	final static String EVENTSFILE = "D:/runs-svn/bmw_carsharing/avparking/cruise/output_events.xml.gz";
	final static String NETWORKFILE = "D:/runs-svn/bmw_carsharing/avparking/cruise/output_network.xml.gz";
