...
public class RunInclusionTaxiScenario {
	...
	public static Controler createControler(Config config, boolean otfvis) {
		...
		controler.addQSimModule(TaxiQSimModules.createModuleForQSimPlugin(JbTaxiOptimizerProvider.class));
	...
	public static void main(String[] args) {
		...
		RunInclusionTaxiScenario.runMany(
				"C:/Users/Joschka/Documents/shared-svn/projects/sustainability-w-michal-and-dlr/data/scenarios/inclusion/config.xml");
	}
}
