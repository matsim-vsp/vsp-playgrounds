package playground.southafrica.sandboxes.nmviljoen.gridExamples;
...
//		int counter = 0;
		...
		try {
			...
			for (Entry<NmvNode, Double> entry : clustCoeffMap.entrySet()) {
//				counter++;
	...
	public static void calculateAndWriteWeakComponents(DirectedGraph<NmvNode,NmvLink> myGraph, String weakCompFile){
		...
		WeakComponentClusterer< NmvNode, NmvLink> weakComps = new WeakComponentClusterer<NmvNode, NmvLink>();
		clusterSet = weakComps.apply(myGraph);
