...
//		Map<NmvLink, Double> map = new HashMap<NmvLink, Double>();
//		Function<NmvLink, Double> f = Functions.forMap(map);

		
		
//		Converter<NmvLink, Double> name = new Converter<NmvLink, Double>();
		Function<NmvLink, Double> weightTransformer = new Function<NmvLink, Double>() {
			@Override
			public Double apply(NmvLink link) {
