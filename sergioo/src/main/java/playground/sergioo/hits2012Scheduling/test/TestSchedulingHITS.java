...
public class TestSchedulingHITS {
	...
	public static void main(String[] args) throws NumberFormatException, IOException, ParseException, ClassNotFoundException {
		...
		LeastCostPathCalculator dijkstra = new DijkstraFactory(true).createPathCalculator(scenario.getNetwork(), disutilityFunction, travelTimeCalculator.getLinkTravelTimes());
