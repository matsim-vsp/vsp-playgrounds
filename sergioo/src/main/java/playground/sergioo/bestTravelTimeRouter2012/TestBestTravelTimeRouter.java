...
public class TestBestTravelTimeRouter {
	...
	public static void main(String[] args) {
		...
		LeastCostPathCalculator.Path shortestPath = new DijkstraFactory(true).createPathCalculator(scenario.getNetwork(), travelDisutility, tt).calcLeastCostPath(o, d, 0, null, null);
		System.out.println(System.currentTimeMillis()-time);
		System.out.println(shortestPath);
		System.out.println(shortestPath.travelTime);
		BestTravelTimePathCalculator bttpc = new BestTravelTimePathCalculatorImpl(scenario.getNetwork(), tt, false);
