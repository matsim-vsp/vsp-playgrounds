	...
	private void readVehicleTypeCapabilities() {
		...
		//TODO: Emissionswerte nicht über Eigenschaften einlesbar :(	
			...
			case "medium18t" : emissionsPerMeter = 0.655;
				break;
			case "medium18telectro" : emissionsPerMeter = 0; // = 0.433; // for research assume carbon-free energy generation
				break;
			case "light8t" : emissionsPerMeter = 0.524;
				break;
			case "light8telectro" : emissionsPerMeter = 0; // = 0.346; // for research assume carbon-free energy generation
				break;
			case "light8t_frozen" : emissionsPerMeter = 0.524; 
				break;
			case "light8telectro_frozen" : emissionsPerMeter = 0; // = 0.524;  // for research assume carbon-free energy generation
			}
