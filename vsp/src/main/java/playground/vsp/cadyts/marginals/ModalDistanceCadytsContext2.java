...
public class ModalDistanceCadytsContext2 implements CadytsContextI<Id<DistanceBin>>, StartupListener, BeforeMobsimListener, AfterMobsimListener, IterationEndsListener {
	...
	@Inject ModalDistancePlansTranslator plansTranslator;

	@Inject TripEventHandler tripEventHandler;
	...
	private AnalyticalCalibrator<Id<DistanceBin>> calibrator;

	@Override
	public AnalyticalCalibrator<Id<DistanceBin>> getCalibrator() {
		return calibrator;
	}

	@Override
	public PlansTranslator<Id<DistanceBin>> getPlansTranslator() {
	...
	public void notifyIterationEnds(IterationEndsEvent event) {
		...
		DistanceDistribution2 simulatedDistanceDistribution = expectedDistanceDistribution.copyWithEmptyBins();
		...
		this.calibrator.afterNetworkLoading((binId, lower, upper, type) -> simulatedDistanceDistribution.getBin(binId).getValue());
