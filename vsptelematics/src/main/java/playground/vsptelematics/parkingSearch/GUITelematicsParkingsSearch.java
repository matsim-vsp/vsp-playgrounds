...
public class GUITelematicsParkingsSearch {

    public static void main(String[] args) {
        Gui.show("ITS Basic MATSim GUI", playground.vsptelematics.parkingSearch.TelematicsParkingSearchController.class);
    }
				...
				<plugins>
			  	<plugin>
						...
						<configuration>
							<archive>
								<manifest>
									<mainClass>playground.vsptelematics.parkingSearch.GUITelematicsParkingSearch</mainClass>
								</manifest>
							</archive>
						</configuration>
					</plugin>
