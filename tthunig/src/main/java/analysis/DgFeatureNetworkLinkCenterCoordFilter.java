 ...
 *
 */
public class DgFeatureNetworkLinkCenterCoordFilter implements NetworkLinkFilter {

	private MathTransform transform;
	private SimpleFeature feature;
	
	public DgFeatureNetworkLinkCenterCoordFilter(CoordinateReferenceSystem networkSrs,
