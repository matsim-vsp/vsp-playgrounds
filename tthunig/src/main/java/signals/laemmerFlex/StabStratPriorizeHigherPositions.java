...
class StabStratPriorizeHigherPositions extends AbstractStabilizationStrategy {

	public StabStratPriorizeHigherPositions(FullyAdaptiveLaemmerSignalController fullyAdaptiveLaemmerSignalController, Network network, Lanes lanes) {
