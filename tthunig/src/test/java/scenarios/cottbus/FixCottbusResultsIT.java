...
public class FixCottbusResultsIT {
	...
	public void testBCContinuedFreeRouteChoice(){
		fixResults(NetworkType.BTU_NET, PopulationType.BTU_POP_MATSIM_ROUTES, SignalType.MS_BTUOPT, 1096817.0);
	}
	
	@Test
	public void testBCContinuedFixedRouteSet(){
		fixResults(NetworkType.BTU_NET, PopulationType.BTU_POP_BTU_ROUTES, SignalType.MS_BTUOPT, 1073110.0);
	}	
	...
	private Config defineConfig(NetworkType netType, PopulationType popType, SignalType signalType) {
		...
		} else if (signalType.equals(SignalType.MS_BTUOPT)){ 
