...
/**
 * An events reader which reads the default events and the additional drt events DrtRequestSubmittedEvent, PassengerRequestRejectedEvent, DrtRequestScheduledEvent.
 * 
 * @author gleich
 *
 */
