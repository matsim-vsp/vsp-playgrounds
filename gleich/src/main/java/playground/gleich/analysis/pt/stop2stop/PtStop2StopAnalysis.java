 ...
 * segment of a pt {@link Departure}.
 *
...
public class PtStop2StopAnalysis implements TransitDriverStartsEventHandler, VehicleArrivesAtFacilityEventHandler,
    ...
    /**
     * Start of a pt service {@link Departure}
     */
    @Override
    ...
    public static final BinaryOperator<Stop2StopAggregation> aggregateStop2StopAggregations() {
        return (entry1, entry2) -> new Stop2StopAggregation(entry1.getDepartures() + entry2.getDepartures(), entry1.getPassengers() + entry2.getPassengers(),
