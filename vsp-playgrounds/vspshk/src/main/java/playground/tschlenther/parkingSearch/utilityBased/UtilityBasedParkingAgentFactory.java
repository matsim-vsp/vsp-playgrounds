 ...
 *
 */
public class UtilityBasedParkingAgentFactory implements AgentFactory {
	 ...
	 */
	@Inject
	public UtilityBasedParkingAgentFactory(QSim qsim) {
		this.qsim = qsim;
	}
	...
	public MobsimAgent createMobsimAgentFromPerson(Person p) {
		ParkingSearchLogic parkingLogic  = new UtilityBasedParkingSearchLogic(network);
		ParkingAgentLogic agentLogic = new UtilityBasedParkingAgentLogic(p.getSelectedPlan(), parkingManager, walkLegFactory,
