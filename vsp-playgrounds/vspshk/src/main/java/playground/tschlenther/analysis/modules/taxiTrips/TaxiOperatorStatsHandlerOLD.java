...
import org.matsim.vehicles.Vehicle;
	 ...
	 */
	public class TaxiOperatorStatsHandlerOLD implements LinkLeaveEventHandler, PersonEntersVehicleEventHandler,
    PersonLeavesVehicleEventHandler, ActivityStartEventHandler, ActivityEndEventHandler
    {
		...
		private int numPTrips = 0;
	    	...
	    	public TaxiOperatorStatsHandlerOLD(Network network) {
