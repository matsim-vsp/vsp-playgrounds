...
//		config.transit().setUseTransit(true);
		...
		new TransitScheduleReaderV1(scenario).readFile(FilePaths.PATH_TRANSIT_SCHEDULE_BERLIN__10PCT);
		...
		config.controler().setOutputDirectory(FilePaths.PATH_OUTPUT_BERLIN__10PCT_NULLFALL);
