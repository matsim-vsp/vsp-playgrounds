...
//		String workingDirectory = "/Users/dominik/Workspace/matsim/contribs/integration/test/output/org/matsim/integration/daily/accessibility/AccessibilityComputationNMBTest_-5.5--2.0/runAccessibilityComputation/";
		String workingDirectory = "../../runs-svn/patnaIndia/run108/jointDemand/policies/0.15pcu/BT-b-BT-mb_50_-1.05-1.05/";
...
//		final List<String> modes = Arrays.asList(new String[]{"pt-walk"});
		final List<String> modes = Arrays.asList(new String[]{TransportMode.bike});
		
		Envelope envelope = new Envelope(307000,324000,2829000,2837000);
...
//		final Double upperBound = 3.5;
		final Double lowerBound = -1.05; // (upperBound - lowerBound) ideally nicely divisible by (range - 2)
		final Double upperBound = 1.05;
