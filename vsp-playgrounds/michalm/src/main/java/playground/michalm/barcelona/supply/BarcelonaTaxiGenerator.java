...
public class BarcelonaTaxiGenerator {
	private static double[] getTaxisPerHourFromRequets() {
		double[] reqsPerHour = { 6785, 5122, 3948, 3770, 2790, 2463, 2727, 3763, 5622, 6083, 5715, 6052, 6142, 6427,
				6607, 7219, 7398, 5541, 6209, 6425, 6496, 5682, 5064, 5505 };

		double[] reqsPerTaxi = { 2.31, 2.02, 1.95, 1.91, 1.77, 1.52, 1.41, 1.53, 1.77, 1.94, 1.77, 1.79, 1.8, 2, 2.04,
				2.06, 2.08, 1.67, 1.66, 1.81, 1.86, 1.92, 1.79, 1.88 };

		return MathArrays.ebeDivide(reqsPerHour, reqsPerTaxi);
	}

	private static double[] getTaxisPerHourFromSurvey() {
		double[] taxisPerHour = { 1215, 1155.8, 1008.2, 976.4, 1045.2, 1473.8, 2389.4, 4568.8, 6491.6, 7263.8, 7259.8,
				7292.8, 7166, 5519.2, 4202.2, 4730.4, 6127.6, 6488, 5922.6, 5154, 3975.6, 2822, 1758.8, 1587.4 };
		return taxisPerHour;
	}
	...
	public static void main(String[] args) throws ParseException {
		...
		double[] taxis0to23 = useSurveyData ? getTaxisPerHourFromSurvey() : getTaxisPerHourFromRequets();
