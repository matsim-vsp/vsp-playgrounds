...
public class OptAVTestIT {
	...
	public final void test1(){
		...
		optAVParams2.setTollingApproach(TollingApproach.PrivateAndExternalCost);
		...
		config3.planCalcScore().getModes().get(DefaultTaxiOptimizerProvider.TAXI_OPTIMIZER).setMonetaryDistanceRate(-1.0);
		...
		optAVParams3.setTollingApproach(TollingApproach.PrivateAndExternalCost);
