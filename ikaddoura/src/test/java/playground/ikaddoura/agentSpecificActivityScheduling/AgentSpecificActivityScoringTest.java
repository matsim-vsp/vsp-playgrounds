...
public class AgentSpecificActivityScoringTest {
	...
	public final void test1() {
		...
		
		{
			...
			actCounter.handleEvent(new ActivityStartEvent(secondActivity1.getStartTime().seconds(), plan1.getPerson().getId(), null, null, "w"));
			scoringFunction.handleActivity(secondActivity1);
			actCounter.handleEvent(new ActivityStartEvent(thirdActivity1.getStartTime().seconds(), plan1.getPerson().getId(), null, null, "h"));
		...
		
		{
			...
			actCounter.handleEvent(new ActivityStartEvent(secondActivity2.getStartTime().seconds(), plan2.getPerson().getId(), null, null, "w"));
			scoringFunction.handleActivity(secondActivity2);
			actCounter.handleEvent(new ActivityStartEvent(thirdActivity2.getStartTime().seconds(), plan2.getPerson().getId(), null, null, "h"));
