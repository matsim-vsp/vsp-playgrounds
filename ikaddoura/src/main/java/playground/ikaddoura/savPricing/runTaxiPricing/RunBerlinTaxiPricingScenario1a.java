...
public class RunBerlinTaxiPricingScenario1a {
	private static final Logger log = Logger.getLogger(RunBerlinTaxiPricingScenario1a.class);
	...
	public static void main(String[] args) {
		...
		if (args.length > 0) {		
			...
			configFileName = baseDirectory + "scenarios/berlin-v5.2-1pct/input/berlin-pricing-taxi1-v5.2-1pct.config.xml";
			...
			runId = "sav-pricing-1";
			outputDirectory = "/Users/ihab/Documents/workspace/runs-svn/sav-pricing/output/output-local-run_" + runId + "/";
		...
		RunBerlinTaxiPricingScenario1a drtPricing = new RunBerlinTaxiPricingScenario1a();
		drtPricing.run();
	}
