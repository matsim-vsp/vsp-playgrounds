...
public class Network2Shape {
	...
	public static void exportNetwork2Shp1(Scenario scenario, String crs, CoordinateTransformation ct){
		
		String outputPath = scenario.getConfig().controler().getOutputDirectory() + "/network-shp/";
