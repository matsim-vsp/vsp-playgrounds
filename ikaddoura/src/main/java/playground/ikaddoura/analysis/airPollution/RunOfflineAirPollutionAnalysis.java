...
public class RunOfflineAirPollutionAnalysis {
	...
	final static String runDirectory = "public-svn/matsim/scenarios/countries/de/berlin/berlin-v5.3-10pct/output-berlin-v5.3-10pct/";	
	final static String runId = "berlin-v5.3-10pct";
...
//	final static String runId = "savA-3d";
	...
	public static void main(String[] args) {
		...
		final String emissionEventOutputFile = rootDirectory + runDirectory + runId + "." + config.controler().getLastIteration() + ".emission.events.offline_2019-02-07.xml.gz";
