		...
		if (createQGisOutput == true) {
			...
			for (String actType : activityTypes) {
				...
				for (String mode : modes) {
					VisualizationUtils.createQGisOutputGraduatedStandardColorRange(actType, mode, envelope, workingDirectory, TransformationFactory.WGS84_UTM33N, includeDensityLayer,
