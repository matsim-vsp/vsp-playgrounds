...
public class GeometryUtilsTest {
    ...
    public void testRandomPointInsideGeometries(){
        ...
        Geometry geometry1 = geometryFactory.createPolygon(new Coordinate[] {new Coordinate(0,0), new Coordinate(50,0), new Coordinate(50,-50), new Coordinate(0,-50), new Coordinate(0,0) } );
        Geometry geometry2 = geometryFactory.createPolygon(new Coordinate[] {new Coordinate(0,10), new Coordinate(0,40), new Coordinate(-50,40), new Coordinate(-50,10), new Coordinate(0,10) } );
        ...
        // first check if any point outside geometry1 and geometry2 lies inside combined geom
        {
            ...
            Assert.assertFalse("The point must not be inside combined geom.", combinedGeom.contains(point));
        }

        // another instersecting geom
        Geometry intersectingGeom = geometryFactory.createPolygon(new Coordinate[] {new Coordinate(20,-5), new Coordinate(20,5), new Coordinate(-20,5), new Coordinate(-20,-5), new Coordinate(20,-5) } );
        ...
        if ( ! geometry1.covers(point) && ! geometry2.covers(point) ) {
            wrongPoint = true; // not in any of the geoms
        }
