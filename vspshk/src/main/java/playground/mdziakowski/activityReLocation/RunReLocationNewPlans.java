...
public class RunReLocationNewPlans {

        private static final Logger log = Logger.getLogger(RunReLocationNewPlans.class);
        ...
        public static void main(String[] args) {
            ...
            if (args.length == 0 || args[0].equals("")) {
                ...
                outputPlans = "D:/Arbeit/Berlin/ReLocation/zweiter Versuch/PlansWithNewLocations2000.xml";
                logFile = "D:/Arbeit/Berlin/ReLocation/zweiter Versuch/log2000";
...
//        oldShoppingActivities.clear();
        ...
        private static void createNewPopulation(String outputPlans, Map<String, Geometry> allZones,
            ...
            for (Person person : population.getPersons().values()) {
                ...
                List<PlanElement> removeElements = new ArrayList<>();
                ...
                for (PlanElement planElement : plan.getPlanElements()) {
                    if (planElement instanceof Activity) {
                        ...
                        else if (activity.getType().contains("shopping")) {
                            if (!(act.equals("noZone"))) {
                        ...
                        } else if (activity.getType().contains("interaction")) {
                            removeElements.add(activity);
                        }
