...
class RunAnalysisTool {
	...
	public static void main(String[] args) {
		...
		pop1routes.put(Id.createLinkId(1660), "pop1 oestlicher ring"); //pop1 oestlicher ring
		pop1routes.put(Id.createLinkId(11842), "pop1 oestliches stadtzentrum"); //pop1 oestliches stadtzentrum
