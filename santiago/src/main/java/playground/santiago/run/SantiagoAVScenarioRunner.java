	...
	private static void setModeChoiceForSubpopulations(final Controler controler) {
		...
		controler.addOverridingModule(new AbstractModule() {
			...
			public void install() {
				...
				final String[] availableModes1 = {TransportMode.car, TransportMode.walk, TransportMode.pt, SantiagoScenarioConstants.COLECTIVOMODE};
				...
				final String[] availableModes2 = {TransportMode.walk, TransportMode.pt, SantiagoScenarioConstants.COLECTIVOMODE};
