...
public class TestEmissionsPerLinkWarmEventHandler {
	...
	public void handleEventTest(){
		...
		Map<String, Double> warmEmissions1 = new HashMap<String, Double>();
		...
		Assert.assertEquals(coValue, handler.getWarmEmissionsPerLinkAndTimeInterval().get(calulatedEndOfTimeInterval).get(linkId).get(WarmPollutant.CO.getText()), MatsimTestUtils.EPSILON);
		Assert.assertEquals(c2Value, handler.getWarmEmissionsPerLinkAndTimeInterval().get(calulatedEndOfTimeInterval).get(linkId).get(WarmPollutant.CO2_TOTAL.getText()), MatsimTestUtils.EPSILON);
		Assert.assertEquals(fcValue, handler.getWarmEmissionsPerLinkAndTimeInterval().get(calulatedEndOfTimeInterval).get(linkId).get(WarmPollutant.FC.getText()), MatsimTestUtils.EPSILON);
		Assert.assertEquals(hcValue, handler.getWarmEmissionsPerLinkAndTimeInterval().get(calulatedEndOfTimeInterval).get(linkId).get(WarmPollutant.HC.getText()), MatsimTestUtils.EPSILON);
		Assert.assertEquals(nmValue, handler.getWarmEmissionsPerLinkAndTimeInterval().get(calulatedEndOfTimeInterval).get(linkId).get(WarmPollutant.NMHC.getText()), MatsimTestUtils.EPSILON);
		Assert.assertEquals(n2Value, handler.getWarmEmissionsPerLinkAndTimeInterval().get(calulatedEndOfTimeInterval).get(linkId).get(WarmPollutant.NO2.getText()), MatsimTestUtils.EPSILON);
		Assert.assertEquals(nxValue, handler.getWarmEmissionsPerLinkAndTimeInterval().get(calulatedEndOfTimeInterval).get(linkId).get(WarmPollutant.NOX.getText()), MatsimTestUtils.EPSILON);
		Assert.assertEquals(pmValue, handler.getWarmEmissionsPerLinkAndTimeInterval().get(calulatedEndOfTimeInterval).get(linkId).get(WarmPollutant.PM.getText()), MatsimTestUtils.EPSILON);
		Assert.assertEquals(soValue, handler.getWarmEmissionsPerLinkAndTimeInterval().get(calulatedEndOfTimeInterval).get(linkId).get(WarmPollutant.SO2.getText()), MatsimTestUtils.EPSILON);
		...
		Map<String, Double> warmEmissions2= new HashMap<String, Double>();
		...
		Map<String, Double> warmEmissions3= new HashMap<String, Double>();
		...
		Map<String, Double> warmEmissions4= new HashMap<String, Double>();
		...
		Assert.assertEquals(2*coValue, handler.getWarmEmissionsPerLinkAndTimeInterval().get(calulatedEndOfTimeInterval).get(linkId).get(WarmPollutant.CO.getText()), MatsimTestUtils.EPSILON);
		Assert.assertEquals(coValue, handler.getWarmEmissionsPerLinkAndTimeInterval().get(simulationEndTime).get(linkId).get(WarmPollutant.CO.getText()), MatsimTestUtils.EPSILON);
		Assert.assertEquals(coValue, handler.getWarmEmissionsPerLinkAndTimeInterval().get(intervalEndOfEvent4).get(linkId).get(WarmPollutant.CO.getText()), MatsimTestUtils.EPSILON);
		...
		for (WarmPollutant wp: WarmPollutant.values()){
			Assert.assertEquals(0.0, handler.getWarmEmissionsPerLinkAndTimeInterval().get(intervalEndOfEvent5).get(linkId2).get(wp.getText()), MatsimTestUtils.EPSILON);
		}		
		...
		Map<String, Double> warmEmissions6= new HashMap<String, Double>();
		event6 = setUpEvent(simulationEndTime, linkId3, vehicleId, warmEmissions6);
		warmEmissions6.remove(WarmPollutant.NMHC.getText());
		warmEmissions6.remove(WarmPollutant.NO2.getText());
		warmEmissions6.remove(WarmPollutant.NOX.getText());
		handler.handleEvent(event6);
		// check event 6
		Assert.assertEquals(1.0, handler.getTime2linkIdLeaveCount().get(simulationEndTime).get(linkId3));
		Assert.assertEquals(coValue, handler.getWarmEmissionsPerLinkAndTimeInterval().get(simulationEndTime).get(linkId3).get(WarmPollutant.CO.getText()), MatsimTestUtils.EPSILON);
		Assert.assertEquals(c2Value, handler.getWarmEmissionsPerLinkAndTimeInterval().get(simulationEndTime).get(linkId3).get(WarmPollutant.CO2_TOTAL.getText()), MatsimTestUtils.EPSILON);
		Assert.assertEquals(fcValue, handler.getWarmEmissionsPerLinkAndTimeInterval().get(simulationEndTime).get(linkId3).get(WarmPollutant.FC.getText()), MatsimTestUtils.EPSILON);
		Assert.assertEquals(hcValue, handler.getWarmEmissionsPerLinkAndTimeInterval().get(simulationEndTime).get(linkId3).get(WarmPollutant.HC.getText()), MatsimTestUtils.EPSILON);
		Assert.assertEquals(0.0, handler.getWarmEmissionsPerLinkAndTimeInterval().get(simulationEndTime).get(linkId3).get(WarmPollutant.NMHC.getText()), MatsimTestUtils.EPSILON);
		Assert.assertEquals(0.0, handler.getWarmEmissionsPerLinkAndTimeInterval().get(simulationEndTime).get(linkId3).get(WarmPollutant.NO2.getText()), MatsimTestUtils.EPSILON);
		Assert.assertEquals(0.0, handler.getWarmEmissionsPerLinkAndTimeInterval().get(simulationEndTime).get(linkId3).get(WarmPollutant.NOX.getText()), MatsimTestUtils.EPSILON);
		Assert.assertEquals(pmValue, handler.getWarmEmissionsPerLinkAndTimeInterval().get(simulationEndTime).get(linkId3).get(WarmPollutant.PM.getText()), MatsimTestUtils.EPSILON);
		Assert.assertEquals(soValue, handler.getWarmEmissionsPerLinkAndTimeInterval().get(simulationEndTime).get(linkId3).get(WarmPollutant.SO2.getText()), MatsimTestUtils.EPSILON);
	...
	private WarmEmissionEvent setUpEvent(double timeOfEvent1, Id<Link> linkId, Id<Vehicle> vehicleId, Map<String, Double> warmEmissions) {
		//warmEmissions = new HashMap<WarmPollutant, Double>();
		warmEmissions.put(WarmPollutant.CO.getText(), new Double(coValue));
		warmEmissions.put(WarmPollutant.CO2_TOTAL.getText(), new Double(c2Value));
		warmEmissions.put(WarmPollutant.FC.getText(), new Double(fcValue));
		warmEmissions.put(WarmPollutant.HC.getText(), new Double(hcValue));
		warmEmissions.put(WarmPollutant.NMHC.getText(), new Double(nmValue));
		warmEmissions.put(WarmPollutant.NO2.getText(), new Double( n2Value));
		warmEmissions.put(WarmPollutant.NOX.getText(), new Double(nxValue));
		warmEmissions.put(WarmPollutant.PM.getText(), new Double(pmValue));
		warmEmissions.put(WarmPollutant.SO2.getText(), new Double(soValue));
