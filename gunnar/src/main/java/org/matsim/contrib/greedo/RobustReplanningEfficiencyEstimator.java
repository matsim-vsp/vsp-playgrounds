 ...
 *
 */
class RobustReplanningEfficiencyEstimator {
	...
	RobustReplanningEfficiencyEstimator(final double inertia, final int minObservationCnt, final int covarianceMemoryLength) {
