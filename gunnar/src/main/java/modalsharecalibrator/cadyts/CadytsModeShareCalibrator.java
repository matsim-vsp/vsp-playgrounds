...
public class CadytsModeShareCalibrator extends Calibrator<String> {
	...
	public CadytsModeShareCalibrator(final String logPath, final double estimatedTotalTripCnt,
			final double reproductionWeight, final double inertia) {
		...
		super.setRegressionInertia(inertia);
